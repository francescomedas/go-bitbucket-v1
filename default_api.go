 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 @return */
 func (a *DefaultApiService) Create(projectKey, repositorySlug string, localVarPostBody interface{}) (*APIResponse, error) {
	 var (
		 localVarHTTPMethod = strings.ToUpper("Post")
		 localVarFileName   string
		 localVarFileBytes  []byte
 ...
 * @param ctx context.Context for authentication, logging, tracing, etc.
 ...
 @return */
 func (a *DefaultApiService) GetTag(projectKey, repositorySlug, name string) (*APIResponse, error) {
	 var (
		 localVarHTTPMethod = strings.ToUpper("Get")
		 localVarPostBody   interface{}
		 localVarFileName   string
  ...
  * @param ctx context.Context for authentication, logging, tracing, etc.
  @param optional (nil or map[string]interface{}) with one or more of:
	  ...
	  @param "orderBy" (string) ordering of refs either ALPHABETICAL (by name) or MODIFICATION (last updated)
  @return */
 func (a *DefaultApiService) GetTags(projectKey, repositorySlug string) (*APIResponse, error) {
	 return a.GetTagsWithOptions(projectKey, repositorySlug, make(map[string]interface{}))
 }
 
 func (a *DefaultApiService) GetTagsWithOptions(project, repository string, localVarOptionals map[string]interface{}) (*APIResponse, error) {
	 var (
		 localVarHTTPMethod = strings.ToUpper("Get")
		 localVarPostBody   interface{}
		 localVarFileName   string
